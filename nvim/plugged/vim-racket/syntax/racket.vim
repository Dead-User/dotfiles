...
syn region racketStruc matchgroup=racketBracket start="\["rs=s+1 matchgroup=racketBracket end="\]"re=e-1 contains=@racketNormal
syn region racketStruc matchgroup=racketBracket start="#\["rs=s+2 matchgroup=racketBracket end="\]"re=e-1 contains=@racketNormal
